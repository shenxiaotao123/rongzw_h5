    ...
    <div class="pageColor" >
      ...
      <div class="tuijian">
        <div class="left" @click="$router.push({path:'/construction'})">
          <img src="../assets/img/home/shigong.png" class="img"/></div>
        <div class="left" @click="$router.push({path:'/designerList'})">
          <img src="../assets/img/home/designer.png" class="img"/></div>
        <div class="right" v-for="ad of ads.app_hot">
          <img :src="ad.pic_url" class="img" @click="$router.push({path:'/glDetail',query:{id:ad.id}})"/></div>
      </div>
      <!--推荐-->
